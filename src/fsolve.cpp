...
void fdjac1 ( std::function<void(int n, double x[], double f[])> fcn, 
...
int fsolve ( std::function<void(int n, double x[], double fvec[])> fcn, int n,
...
int hybrd ( std::function<void(int n, double x[], double fvec[])> fcn,
  int n, double x[],
